...
import type { AccessDto, LoginDto, NodesDto, UserDto } from '../models'
import {
  AccessDtoFromJSON,
  AccessDtoToJSON,
  LoginDtoFromJSON,
...
export class AppApi extends runtime.BaseAPI {
   ...
   * Fetch saved nodes.
   */
  async appControllerGetNodesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<NodesDto>> {
    const queryParameters: any = {}
   ...
   * Login.
   */
  async appControllerLoginRaw(
    requestParameters: AppControllerLoginRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AccessDto>> {
    if (requestParameters.LoginDto === null || requestParameters.LoginDto === undefined) {
      throw new runtime.RequiredError(
        'LoginDto',
        'Required parameter requestParameters.LoginDto was null or undefined when calling appControllerLogin.',
      )
    }
   ...
   * Save all nodes.
   */
  async appControllerSaveNodesRaw(
    requestParameters: AppControllerSaveNodesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<NodesDto>> {
    if (requestParameters.NodesDto === null || requestParameters.NodesDto === undefined) {
      throw new runtime.RequiredError(
        'NodesDto',
        'Required parameter requestParameters.NodesDto was null or undefined when calling appControllerSaveNodes.',
      )
    }
